...
![welcome-to-hangman](images/features/welcome-to-hangman.png)
...
- [User Experience](#)
    ...
    - [Application Goal](#project-goal)
    - [Requirements and Expectations](#requirements-and-expectations)
    - [Application Flow and Logic](#appflow)
...
- [PEP8 Code Institute](https://pep8ci.herokuapp.com/#)
    - Used to lint Python code to see if any mistakes or issues came up.
...
10. Finally, click the **Open App** button at the top-right corner of the screen and the application should run and you will be able to play hangman!
    <details><summary>Picture</summary>
    <img src="images/deployment/heroku-7.png" alt="heroku"/>
    <img src="images/deployment/heroku-play.png" alt="heroku"/>
    </details>
    <br>

# CREDITS

- Code Institute LMS Learning Modules
- Mentor Simen Daelin for guidance
- Some Youtube videos such as Youtube Channel: NPStation for general guidance on the structure of creating a hangman game.
- patorjk.com for ascii art
- PEP8 linter tool from Code Institute for testing